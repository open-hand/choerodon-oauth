...
package springframework.security.oauth2.provider.endpoint;
...
import org.hzero.oauth.security.social.CustomSocialUserDetailsService;
 ...
 */
@FrameworkEndpoint
public class TokenEndpoint extends AbstractEndpoint implements ApplicationContextAware {
    ...
    private CustomSocialUserDetailsService customSocialUserDetailsService;
    ...
    public ResponseEntity<OAuth2AccessToken> postAccessToken(Principal principal, @RequestParam
        ...
        TokenEvent tokenEvent = new TokenEvent(request, tokenRequest, token);
        applicationContext.publishEvent(tokenEvent);
