...
package springframework.security.web.savedrequest;
 ...
 * and {@link SavedRequestAwareWrapper} to
...
public class DefaultSavedRequest implements SavedRequest {
	...
	public String getRedirectUrl() {
		...
		//		queryString);
		logger.debug("get redirectUrl from SavedRequest: {}", absoluteRedirectUrl);
	...
	public static class Builder {
		...
		public org.springframework.security.web.savedrequest.DefaultSavedRequest build() {
			org.springframework.security.web.savedrequest.DefaultSavedRequest savedRequest = new org.springframework.security.web.savedrequest.DefaultSavedRequest(this);
